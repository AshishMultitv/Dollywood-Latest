...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SAJsonParser/SAJsonParser.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SAModelSpace/SAModelSpace.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SANetworking/SANetworking.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SAUtils/SAUtils.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SAVASTParser/SAVASTParser.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SAVideoPlayer/SAVideoPlayer.framework"
