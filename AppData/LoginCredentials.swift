...
class LoginCredentials: NSObject {
    ...
    //////////Favriout------ 34-----------/////////////
    static var Privacypolicyapi: String {
        get {
            
            if let privacypolicyapi = UserDefaults.standard.object(forKey: "privacypolicyapi") as? String {
                return privacypolicyapi
            }
            return String()
        }
        set {
            UserDefaults.standard.set(newValue, forKey: "privacypolicyapi")
            UserDefaults.standard.synchronize()
        }
    }
    
    //////////Favriout------ 34-----------/////////////
    static var Termsandconditioncapi: String {
        get {
            
            if let termsandconditioncapi = UserDefaults.standard.object(forKey: "termsandconditioncapi") as? String {
                return termsandconditioncapi
            }
            return String()
        }
        set {
            UserDefaults.standard.set(newValue, forKey: "termsandconditioncapi")
            UserDefaults.standard.synchronize()
        }
    }
